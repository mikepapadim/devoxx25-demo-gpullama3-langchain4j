...
public class Conversation {
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        // Bot1 System Message
        SystemMessage systemMessage1 = SystemMessage.from(
                "Your name is Bot1. "
        ...
        // Bot2 System Message
        SystemMessage systemMessage2 = SystemMessage.from(
                "Your name is Bot2."
                        + "Your user is Bot1."
                        + "You hold number 4."
                        + "You should collaborate for problem solving by either asking a one question or answering."
        ...
        request = ChatRequest.builder()
                ...
                .build();
        bot1.chat(request, createStreamingHandler(futureResponse1));
        // step3:
        ...
        request = ChatRequest.builder()
                ...
                .build();
        bot2.chat(request, createStreamingHandler(futureResponse2));
        ...
        request = ChatRequest.builder()
                .messages(agent1Memory.messages())
                .build();
        bot1.chat(request, createStreamingHandler(futureResponse3));
        ...
        request = ChatRequest.builder()
                .messages(agent2Memory.messages())
                .build();
        bot2.chat(request, createStreamingHandler(futureResponse4));
